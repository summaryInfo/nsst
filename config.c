...
static struct option options[] = {
    ...
    X(boolean, allow_uris, "allow-uris", "Allow URI parsing/clicking", true),
    ...
    X(boolean, cut_lines, "cut-lines", "Cut long lines on resize with rewrapping disabled", false),
    ...
    X(boolean, rewrap, "rewrap", "Rewrap text on resize", true),
