...
static struct option options[] = {
    ...
    X(enum, bell_volume, "bell", "Bell setting", 2, 0, XENUM("off", "low", "high")),
    ...
    X(string, key[shortcut_font_down], "key-dec-font", "Decrement font size hotkey", "T-Less"),
    X(string, key[shortcut_font_up], "key-inc-font", "Increment font size hotkey", "T-Greater"),
    ...
    X(string, key[shortcut_view_top], "key-jump-top", "Jump to the top of the scrollback buffer", "T-T"),
    X(string, key[shortcut_view_bottom], "key-jump-bottom", "Jump to the bottom of the scrollback buffer", "T-G"),
    ...
    X(string, key[shortcut_scroll_up_long], "key-page-up", "Scroll up (long) hotkey", "T-Page_Up"),
    X(string, key[shortcut_select_all], "key-select-all", "Select whole scrollback buffer", "T-A"),
    X(string, key[shortcut_force_mouse], "key-force-mouse", "Toggle forced terminal mouse interaction", "T-S"),
    ...
    G1(enum, log_level, 'L', "log-level", "Filtering level of logged information", 3, 0, XENUM("quiet", "fatal", "warn", "info")),
    ...
    X(uint8, margin_bell_high_volume, "margin-bell-high-volume", "High volume value for DECSMBV", 100, 0, 100),
    X(uint8, margin_bell_low_volume, "margin-bell-low-volume", "Low volume value for DECSMBV", 50, 0, 100),
    X(enum, margin_bell_volume, "margin-bell", "Margin bell setting", 2, 0, XENUM("off", "low", "high")),
    ...
    X(enum, modify_other_fmt, "modify-other-fmt", "Format of encoding modifiers", 0, 0, XENUM("xterm", "csi-u")),
    X(uint8, modify_other, "modify-other", "Enable encoding modifiers for other keys", 0, 0, 4),
    X(string, notify_command, "notify-cmd", "A command used for sending desktop notifications", "notify-send"),
    ...
    X(int16, scroll_amount, "scroll-amount", "Number of lines scrolled in a time for a short scroll", 2, 0, 1000),
    X(int16, page_amount, "page-amount", "Number of lines scrolled in a time for a long scroll", -1, 0, 1000),
